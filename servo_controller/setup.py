...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "joystick_to_joint_control_n = servo_controller.joystick_to_joint_control_n:main",
            "initial_joint_position_publisher = servo_controller.initial_joint_position_publisher:main",
        ],
    },
)
